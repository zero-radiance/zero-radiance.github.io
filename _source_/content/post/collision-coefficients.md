...
\begin{aligned}
	& \bm{E_s}(\bm{r}, \omega)
	= k^2(\omega) \iiint\_{V} \mathcal{G_{e}} \big( \bm{r} - \bm{r'}, k(\omega) \big) \big( m^2(\bm{r'}, \omega) - 1 \big) \bm{E}(\bm{r'}, \omega) dV', \cr
	& \bm{B_s}(\bm{r}, \omega)
	= \frac{i}{\omega} k^2(\omega) \iiint\_{V} \mathcal{G_{m}} \big( \bm{r} - \bm{r'}, k(\omega) \big) \big( m^2(\bm{r'}, \omega) - 1 \big) \bm{E}(\bm{r'}, \omega) dV'.
\end{aligned}
$$
